<header className="header_wrap fixed-top light_skin hover_menu_style2 transparent-header">
  <div className="container">
    <nav className="navbar navbar-expand-lg"> 
        ...
        <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span className="ion-android-menu"></span> </button>
      	<div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav">
                <li>
                    <a className="nav-link active page-scroll" href="#home_section">Home</a>
                </li>
                <li>
                ...
                <li>
                    <a className="nav-link page-scroll" href="#experience">Experience</a>
                </li>
                <li>
